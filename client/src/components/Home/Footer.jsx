...
const Footer = () => {
    return (
        <>
            ...
            <footer className="bg-[#131413] w-full max-w-337.5 mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden mt-40">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <p className="text-sm/6 text-neutral-300 max-w-96">Resume-AI helps you build faster by transforming your design vision into fully functional, company-ready Resume.</p>
                        <div className="flex gap-5 md:gap-6 order-1 md:order-2">
                            ...
                            {/* Github */}
                            <a href="https://github.com/Raj-2006-10-01" target='_blank' className="text-white hover:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" /><path d="M9 18c-4.51 2-5-2-7-2" />
                                </svg>
                            </a>
                            {/* Linkedin */}
                            <a href="https://www.linkedin.com/in/raj-kishore-sahoo-b28403362?utm_source=share_via&utm_content=profile&utm_medium=member_android" target='_blank' className="text-white hover:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/_r_a_j_._69?utm_source=qr&igsh=MW5zdzl6Y3pjZXIxdg==" target='_blank' className="text-white hover:text-gray-300">
