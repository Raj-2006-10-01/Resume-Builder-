    ...
    return (
        <>
            ...
            <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
                <div className="flex items-center gap-2 text-sm text-blue-800 bg-green-400/10  rounded-full px-6 py-1.5">
                    <BookUserIcon className='size-4.5 stroke-gray-600' />
                    <span>Testimonials.</span>
                </div>
                <Title title=" Don't Just take our words" description="Hear what our users say about us. we're always looking for ways to improve . if you have a positive exprience with us, leave a review." />
            </div>
